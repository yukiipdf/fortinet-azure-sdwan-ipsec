...
5. **Configuration**  
   After installation, you’ll need to configure the application to work with your Azure environment. Guidance on how to set this up can be found in the documentation that comes with the software.

6. **Launch the Application**  
   Once configured, you can launch the application from your computer. Follow any additional steps that may appear for first-time runs.

## 📚 Features
- **Security**: Set up secure connections using Fortinet’s security features.
- **Automation**: Streamline your network management with automation.
...
- Check if antivirus software is blocking the installer.
- Reference the documentation for common fixes.

## 📞 Contact
For further assistance, please open an issue in the GitHub repository or join our community discussions. We’re here to help!

Feel free to explore and utilize the features of Fortinet SD-WAN and IPsec on Azure. Thank you for using our application!